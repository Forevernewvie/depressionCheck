...
class AppLocalizationsKo extends AppLocalizations {
  ...
  @override
  String get settingsPrivacyPolicySubtitle => '앱이 처리하는 정보와 저장 방식을 확인하세요.';
  ...
  String get privacyPolicySummary =>
      '이 문서는 현재 앱 구현 기준으로 어떤 정보가 기기 안팎에서 처리되는지 설명합니다.';

  @override
  String get privacyPolicyLastUpdatedLabel => '최종 업데이트';

  @override
  String get privacyPolicyLastUpdatedValue => '2026-03-08';

  @override
  String get privacyPolicyDataTitle => '1. 처리하는 정보';

  @override
  String get privacyPolicyDataBody =>
      '앱은 설정 정보(테마, 언어, 온보딩 상태), 체크인 정보(기분, 에너지, 메모, 기록 시각), 안전 플랜 정보(위험 신호, 대처 방법, 안전 이유, 응급 단계), 신뢰 연락처 정보(이름, 관계, 전화번호, 주요 연락처 여부), 위치 정보(주변 진료기관 검색 시), 그리고 오류/장애 대응을 위한 기술 로그를 처리할 수 있습니다.';

  @override
  String get privacyPolicyPurposeTitle => '2. 이용 목적';

  @override
  String get privacyPolicyPurposeBody =>
      '이 정보는 선별 흐름 제공, 결과 안내, 체크인과 안전 플랜 저장, 주변 진료기관 검색, 전화/길찾기 연결, 테마/언어 설정 유지, 비핵심 화면 광고 표시, 오류 분석을 위해 사용됩니다.';

  @override
  String get privacyPolicyStorageTitle => '3. 저장 위치와 보관 방식';

  @override
  String get privacyPolicyStorageBody =>
      '모바일·데스크톱 빌드에서는 Isar 로컬 데이터베이스에 저장되고, 웹에서는 브라우저 localStorage에 저장됩니다. 앱은 기본적으로 계정 서버를 만들지 않으며, 대부분의 정보는 사용자의 기기 안에 남습니다.';

  @override
  String get privacyPolicySharingTitle => '4. 외부 전송과 제3자 제공';

  @override
  String get privacyPolicySharingBody =>
      '주변 진료기관 검색을 실행하면 현재 위치와 검색 반경이 외부 Overpass 조회 엔드포인트로 전송될 수 있습니다. 전화나 길찾기 버튼을 누르면 운영체제 또는 외부 앱으로 이동하며, 이후 처리는 해당 플랫폼 정책이 적용됩니다. 선별 답변, 체크인, 안전 플랜, 신뢰 연락처는 기본 서버로 업로드하지 않습니다.';

  @override
  String get privacyPolicyAdsTitle => '5. 광고와 외부 SDK';

  @override
  String get privacyPolicyAdsBody =>
      '광고가 활성화된 빌드에서는 Google Mobile Ads SDK가 광고 요청을 처리할 수 있습니다. 현재 저장소 기준으로 별도의 사용자 행동 분석 SDK는 확인되지 않았지만, 광고 제공사 정책에 따른 기술 정보 처리가 발생할 수 있습니다.';

  @override
  String get privacyPolicySecurityTitle => '6. 보안';

  @override
  String get privacyPolicySecurityBody =>
      '앱은 구조화된 로깅과 민감정보 마스킹을 사용해 직접적인 개인정보 노출을 줄이도록 설계되었습니다. 다만 공유 기기 사용, 기기 분실, 악성 소프트웨어 감염 같은 상황에서는 로컬 저장 정보가 노출될 수 있습니다.';

  @override
  String get privacyPolicyControlTitle => '7. 이용자 선택권';

  @override
  String get privacyPolicyControlBody =>
      '위치 권한은 거부할 수 있으며 이 경우 기본 진료기관 목록이 제공됩니다. 연락처 추가·삭제와 주요 연락처 지정은 앱 안에서 변경할 수 있습니다. 전체 로컬 데이터 삭제 전용 기능은 현재 별도로 제공되지 않으므로, 전체 삭제가 필요하면 앱 삭제 또는 브라우저 저장소 정리가 필요할 수 있습니다.';

  @override
  String get privacyPolicyContactTitle => '8. 문의 및 고지';

  @override
  String get privacyPolicyContactBody =>
      '현재 저장소에는 별도 운영자 문의처가 내장되어 있지 않습니다. 외부 배포 전에는 앱 스토어 설명 또는 지원 페이지에 운영자 연락처와 최신 정책 링크를 함께 제공하는 것을 권장합니다.';
